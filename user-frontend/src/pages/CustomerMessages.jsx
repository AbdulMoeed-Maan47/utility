...
export default function CustomerMessages() {
  ...
  return (
    <div
      className="flex h-full -m-6 lg:-m-8"
      ...
      <div className="flex-1 flex flex-col">
        {!activeUser ? (
          ...
          <>
            ...
            <div className="px-4 py-3 border-t bg-white flex gap-3 shrink-0">
              <input
                value={text}
              ...
              <button
                onClick={sendMessage}
                className="p-2.5 rounded-xl bg-sky-500 hover:bg-sky-600 text-white"
              >
                <Send size={18} />
              </button>
            </div>
